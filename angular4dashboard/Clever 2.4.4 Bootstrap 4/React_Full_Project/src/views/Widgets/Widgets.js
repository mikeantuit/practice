          ...
          <div className="col-sm-6 col-lg-3">
            <div className="card">
              <div className="card-block">
                ...
                <div>Lorem ipsum...</div>
                <Progress className="progress-xs my-3" color="success" value="25" />
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="card">
              <div className="card-block">
                ...
                <div>Lorem ipsum...</div>
                <Progress className="progress-xs my-3" color="info" value="25" />
                <small className="text-muted">Lorem ipsum dolor sit amet enim.</small>
              </div>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div className="card">
              <div className="card-block">
                ...
                <div>Lorem ipsum...</div>
                <Progress className="progress-xs my-3" color="warning" value="25" />
                <small className="text-muted">Lorem ipsum dolor sit amet enim.</small>
              </div>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div className="card">
              <div className="card-block">
                ...
                <div>Lorem ipsum...</div>
                <Progress className="progress-xs my-3" color="danger" value="25" />
                <small className="text-muted">Lorem ipsum dolor sit amet enim.</small>
              </div>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="card card-inverse card-primary">
              <div className="card-block">
                <div className="h4 m-0">89.9%</div>
                <div>Lorem ipsum...</div>
                <Progress className="progress progress-white progress-xs my-3" value="25" />
                <small className="text-muted">Lorem ipsum dolor sit amet enim.</small>
              </div>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-md-2">
            <div className="card card-inverse card-info">
              <div className="card-block">
                ...
                <div className="h4 mb-0">87.500</div>
                <small className="text-muted text-uppercase font-weight-bold">Visitors</small>
                <Progress className="progress progress-white progress-xs mt-3" value="25" />
              </div>
            </div>
          </div>
          <div className="col-sm-6 col-md-2">
