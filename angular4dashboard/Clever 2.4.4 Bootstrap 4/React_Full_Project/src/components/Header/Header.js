  ...
  render() {
    return (
      <header className="app-header navbar">
        ...
        <ul className="nav navbar-nav d-md-down-none b-r-1">
          <li className="nav-item">
            <a className="nav-link navbar-toggler sidebar-toggler" onClick={this.sidebarToggle} href="#">&#9776;</a>
          </li>
        </ul>
        <form className="form-inline float-left b-r-1 px-4 d-md-down-none">
        ...
        <ul className="nav navbar-nav ml-auto">
          ...
          <li className="nav-item d-md-down-none">
            <a className="nav-link nav-pill" href="#"><i className="icon-list"></i></a>
          </li>
          <li className="nav-item d-md-down-none">
            <a className="nav-link nav-pill" href="#"><i className="icon-location-pin"></i></a>
          </li>
